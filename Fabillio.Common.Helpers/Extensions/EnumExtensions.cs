...
public static class EnumExtensions
{
    ...
    public static bool TryReadEnumValue<TEnum>(string strValue, out TEnum value) where TEnum : struct
    {
        ...
        foreach (var field in fields)
        {
            ...
            if (field.Name == strValue || (attributes.Length > 0 && attributes[0].Description == strValue))
            {
