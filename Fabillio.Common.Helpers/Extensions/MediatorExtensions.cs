...
public static class MediatorExtensions
{
    ...
    /// </summary>
    public static async Task PublishDomainEventAsync(this IMediator mediator, ISamvirkDomainEvent domainEvent, ILogger logger, CancellationToken cancellationToken = default)
    {
        ...
        {
            var warning = $"Processing of the domain event {domainEvent.DomainEventId} of type {domainEvent.GetType().Name} took {timer.Elapsed.Seconds}s";
