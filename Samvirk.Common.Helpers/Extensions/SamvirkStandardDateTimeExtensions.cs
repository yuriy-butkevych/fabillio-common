...
public static class SamvirkStandardDateTimeExtensions
{
    ...
    public static bool IsLongerThan(
    ...
    public static bool HasElapsedTime(
        DateTime fromDate,
        int elapsedTimeThreshold,
        Periodicity elapsedTimeUnit,
        out int elapsedTime
    )
    {
    ...
    public static bool IsTimePassed(
    ...
    )
    {
        if (minutesThreshold <= 0)
        {
            throw new ArgumentException(
                "The minutes threshold must be greater than zero.",
                nameof(minutesThreshold)
            );
        }
